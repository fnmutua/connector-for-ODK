...
SOURCES = \
	__init__.py \
	connect_odk.py connect_odk_dialog.py

PLUGINNAME = connect_odk
...
EXTRAS = metadata.txt download.svg split.svg logo.svg logo.png qaqc.svg upload.svg upload2.svg
